...
final class AuthManager {
    ...
    struct Constants {
        static let clientID = "4ecb896e5f08432faf30911b76359200"
        static let clientSecret = "d0a015c2b7b44682b791efd26f04b919"
    ...
    public func withValidToken(completion: @escaping (String) -> Void) {
        ...
        if shouldRefreshToken {
            // Refresh
            refreshIfNedeed { [weak self] success in
    ...
    public func refreshIfNedeed(completion: ((Bool) -> Void)?) {
        guard !refreshingToken else {
            return
        }
